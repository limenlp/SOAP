...
def soapnoteagent(rubric,system_prompt,llm_config):
...
def single_agent_generation(conversation,rubric,system_prompt,llm_config):
    clinician=soapnoteagent(rubric,system_prompt,llm_config)
    message = {"role": "user",
